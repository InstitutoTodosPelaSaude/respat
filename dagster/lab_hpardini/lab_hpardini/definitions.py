...
from .assets import respiratorios_dbt_assets, hpardini_raw, hpardini_remove_used_files
...
defs = Definitions(
    assets=[respiratorios_dbt_assets, hpardini_raw, hpardini_remove_used_files],
    schedules=schedules,
    resources={
