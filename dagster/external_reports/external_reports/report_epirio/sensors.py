...
from .jobs import report_epirio_assets_job
...
def run_report_epirio_sensor(context: SensorEvaluationContext):
    # Get the last run status of the job
    job_to_look = 'report_epirio_assets_job'
...
report_epirio_slack_failure_sensor = make_slack_on_run_failure_sensor(
    monitored_jobs=[report_epirio_assets_job],
