...
@asset(
    ...
    deps=[
        ...
        get_asset_key_for_model([respiratorios_dbt_assets], "matrix_38_Resp_painel_pyr_pos_agegroups_all_quarter_country"),
...
def export_matrices_to_xlsx(context):
    ...
    matrices_name_map = {
        ...
        "matrix_38_Resp_painel_pyr_pos_agegroups_all_quarter_country":  "38_Resp_painel_pyr_pos_agegroups_all_quarter_country",
