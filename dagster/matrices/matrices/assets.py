...
@asset(
    ...
    deps=[
        ...
        get_asset_key_for_model([respiratorios_dbt_assets], "matrix_38_SC2_line_posrate_bar_pos_direct_week_centralwest_sive"),
...
def export_matrices_to_xlsx(context):
    ...
    matrices_name_map = {
        ...
        "matrix_38_SC2_line_posrate_bar_pos_direct_week_centralwest_sive":"38_SC2_line_posrate_bar_pos_direct_week_centralwest_sivep",
