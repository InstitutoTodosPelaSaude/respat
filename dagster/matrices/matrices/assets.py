...
@asset(
    ...
    deps=[
        ...
        get_asset_key_for_model([respiratorios_dbt_assets], "matrix_38_SC2_line_posrate_bar_pos_direct_week_centralwest_sivep"),
        get_asset_key_for_model([respiratorios_dbt_assets], "matrix_38_SC2_line_posrate_bar_pos_direct_week_north_sivep"),
        get_asset_key_for_model([respiratorios_dbt_assets], "matrix_38_SC2_line_posrate_bar_pos_direct_week_northeast_sivep"),
        get_asset_key_for_model([respiratorios_dbt_assets], "matrix_38_SC2_line_posrate_bar_pos_direct_week_south_sivep"),
        get_asset_key_for_model([respiratorios_dbt_assets], "matrix_38_SC2_line_posrate_bar_pos_direct_week_southeast_sivep"),
...
def export_matrices_to_xlsx(context):
    ...
    matrices_name_map = {
        ...
        "matrix_38_SC2_line_posrate_bar_pos_direct_week_centralwest_sivep":"38_SC2_line_posrate_bar_pos_direct_week_centralwest_sivep",
        "matrix_38_SC2_line_posrate_bar_pos_direct_week_north_sivep":   "38_SC2_line_posrate_bar_pos_direct_week_north_sivep",
        "matrix_38_SC2_line_posrate_bar_pos_direct_week_northeast_sivep":"38_SC2_line_posrate_bar_pos_direct_week_northeast_sivep",
        "matrix_38_SC2_line_posrate_bar_pos_direct_week_south_sivep":   "38_SC2_line_posrate_bar_pos_direct_week_south_sivep",
        "matrix_38_SC2_line_posrate_bar_pos_direct_week_southeast_sivep":"38_SC2_line_posrate_bar_pos_direct_week_southeast_sivep",
