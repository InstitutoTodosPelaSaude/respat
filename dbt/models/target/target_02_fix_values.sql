...
FROM source_table
WHERE 
    exame NOT IN ('DENVQL', 'CHIKVQL', 'ZIKVQL', 'PMDZC') -- REMOVE ARBO-RELATED TESTS
    AND result NOT IN ('INDETERMINADO', 'INCONCLUSIVO')
    AND exame NOT IN ('COV19LVI') -- TEMPORARY - TODO: SET TEST_KIT FOR EACH TEST IN THIS LINE