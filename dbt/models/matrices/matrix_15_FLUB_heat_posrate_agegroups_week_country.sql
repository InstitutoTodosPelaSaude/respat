...
flub_data AS (
    SELECT
        ...
        MAX(CASE WHEN pathogen = 'FLUB' THEN "posrate" * 100 ELSE NULL END) AS "percentual",
        SUM(CASE WHEN pathogen = 'FLUB' THEN "Pos" ELSE 0 END)::int    AS "pos",
        SUM(CASE WHEN pathogen = 'FLUB' THEN "Neg" ELSE 0 END)::int    AS "neg"
    FROM source_data
