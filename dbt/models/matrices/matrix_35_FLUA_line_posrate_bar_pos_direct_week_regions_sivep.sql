...
source_total_posrate AS (
    SELECT
        ...
        MAX(CASE WHEN sc.pathogen = 'FLUA' THEN sc."posrate" * 100 ELSE NULL END) as "Positividade Total"
...
sivep_pos AS (
    SELECT
        ...
        sc.region,
        sc.state,
        SUM(CASE WHEN sc.pathogen = 'FLUA' THEN sc."Pos" ELSE 0 END)::int AS "sivep_pos"
    FROM sivep_data sc
