...
def fix_datatable(df):
    ...
    # Fix new EXAME names to match with the old ones and keep the same sample_id
    df["EXAME"] = df["EXAME"].str.strip()
    fix_exame_dict = {
        ## COVID
        'PCR EM TEMPO REAL PARA DETECçãO DE CORONAVIRUS': 'PCR EM TEMPO REAL PARA DETECÇÃO DE C',
        'TESTE RáPIDO-ANTíGENO COVID-19 (SARS COV-2)': 'TESTE RÁPIDO-ANTÍGENO COVID-19 (SARS COV',
        'TESTE MOLECULAR COVID-19, AMPLIFICAçãO ISOTERMICA': 'TESTE MOLECULAR COVID-19, AMPLIFICAÇ',
        'OPERAçãO AEROPORTO PCR COVID-19': 'OPERAÇÃO AEROPORTO PCR COVID-19',
        'PCR PAINEL DE PATOGENOS RESPIRATORIO': 'PCR PAINEL DE PATOGENOS RESPIRATORIO',
        'OPERAçãO AEROPORTO ANTíGENO COVID-19': 'OPERAÇÃO AEROPORTO ANTÍGENO COVID-19',
        'PCR COVID19 EXPRESS': 'PCR COVID19 EXPRESS',
        '24 HRS COMPANHIA AéREA - PCR COVID19': '24 HRS COMPANHIA AÉREA - PCR COVID19',
        'HMSC - TESTE MOLECULAR ISOTéRMICO COVID-19': 'HMSC - TESTE MOLECULAR ISOTÉRMICO COVID-',
        # 'SALIVA, PCR PARA COVID-19': '',
        # 'PAINEL MOLECULAR PATOGENOS RESPIRATORIOS': '',
        'TX PCR COVID19': 'TX PCR COVID19',
        # 'INATIVO PMPR': '',
        'EXCLUSIVO EMPRESAS PCR COVID-19': 'EXCLUSIVO EMPRESAS PCR COVID-19',
        'ZZTESTE MOLECULAR COVID-19, AMPLIFICAçãO ISOTERMICA': 'ZZTESTE MOLECULAR COVID-19, AMPLIFICAÇ',
        'HMSC - TESTE MOLECULAR ISOTéRMICO': 'HMSC - TESTE MOLECULAR ISOTÉRMICO COVID-',

        ## VSR
        'PESQ RáPIDA VíRUS SINCICIAL RESPIRATóRIO': 'PESQ RÁPIDA VÍRUS SINCICIAL RESPIRAT',

        ## INFLUENZA
        'PESQUISA RáPIDA PARA INFLUENZA A E B': 'PESQUISA RÁPIDA PARA INFLUENZA A E B',
        'PESQUISA RáPIDA PARA INFLUENZA A E B GL': 'PESQUISA RÁPIDA PARA INFLUENZA A E B',
        'ZZPESQUISA RáPIDA PARA INFLUENZA A E B GL': 'PESQUISA RÁPIDA PARA INFLUENZA A E B',
    }
    df["EXAME"] = df["EXAME"].replace(fix_exame_dict)
    ...
    test_kit_dict = {
        ...
        'SALIVA, PCR PARA COVID-19': 'covid_pcr',
        'PAINEL MOLECULAR PATOGENOS RESPIRATORIOS': 'covid_pcr',
        'INATIVO PMPR': 'covid_pcr',
    }
